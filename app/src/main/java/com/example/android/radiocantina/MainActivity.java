...
public class MainActivity extends AppCompatActivity {
    ...
    public void createList(){
        ...
        //mList.add(new ListItem(R.drawable.norahjones2, "Norah Jones", "Feels Like Home")); // enable after rebuild
    ...
    public void buildRecyclerView (){
        ...
        mAdapter.setOnItemClickListener(new ListAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(int position) { //if i add params I could pass position as
                mList.get(position);
                if (position == 0){
